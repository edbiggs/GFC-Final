...
class Van(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            'last_front_tire_change_date':self.last_front_tire_change_date,
            'last_rear_tire_change_date':self.last_rear_tire_change_date,
            'last_trans_fluid_change_milage':self.last_trans_fluid_change_milage,
            'last_battery_change_date':self.last_battery_change_date,            
            ...
            'last_state_inspection_date':self.last_state_inspection_date,                         
            'last_registration_renewal_date':self.last_registration_renewal_date,
